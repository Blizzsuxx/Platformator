...
{
    j = nlohmann::json{{"rotation", gameObject.getRotation()}, {"active", gameObject.getActive()}, {"position", gameObject.getPosition()}, {"scale", gameObject.getScale()}, {"name", gameObject.getName()}, {"tag", gameObject.getTag()}};
}
