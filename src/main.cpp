...
int main(int argc, char *args[])
{
    ...
    wallSouth->addComponent(new Sprite(wallSouth, wallTexture, SDL_FLIP_NONE, static_cast<int>(wallWidth), static_cast<int>(wallThickness)));
    ...
    wallNorth->addComponent(new Sprite(wallNorth, wallTexture, SDL_FLIP_NONE, static_cast<int>(wallWidth), static_cast<int>(wallThickness)));
    ...
    wallWest->addComponent(new Sprite(wallWest, wallTexture, SDL_FLIP_NONE, static_cast<int>(wallThickness), static_cast<int>(wallHeight)));
    ...
    wallEast->addComponent(new Sprite(wallEast, wallTexture, SDL_FLIP_NONE, static_cast<int>(wallThickness), static_cast<int>(wallHeight)));
