...
{
    j = nlohmann::json{{"velocity", rigidbody.getVelocity()}, {"force", rigidbody.getForce()}, {"mass", rigidbody.getMass()}, {"angularVelocity", rigidbody.getAngularVelocity()}, {"torque", rigidbody.getTorque()}, {"friction", rigidbody.getFriction()}, {"restitution", rigidbody.getRestitution()}, {"bodyType", rigidbody.getBodyType()}, {"gravity", rigidbody.getGravity()}};
}
